...
function pagesPayload(failOpen=false){const context=name=>({...structuredClone(LANE_B_CONTRACT.pagesRuntime),compatibility_date:'2026-06-23',compatibility_flags:[],fail_open:failOpen,...structuredClone(LANE_B_CONTRACT.pagesBindings[name])});return{deployment_configs:{production:context('production'),preview:context('preview')}};}
