...
// The staged MapLibre adapter exposes completed Deck layers through deckRenderedLayers().
// Keep this literal in sync with both protected staging checkouts; production keeps CONTROL_SHA.
